...
import com.example.ecommerce.dtos.PedidoStatusDTO;
...
public class PedidoService {
	...
	public int updatePedidoStatus(Boolean statusPedido, Integer idPedido) {
		return pedidoRepository.updatePedidoStatus(statusPedido, idPedido);
	}
	...
	public PedidoStatusDTO atualizarPedidoStatus(Pedido pedido){
		PedidoStatusDTO psd = new PedidoStatusDTO();
		psd.setId(pedido.getIdPedido());
		psd.setStatus(pedido.getStatusPedido());
		return psd;
	}
	
	public Pedido atualizarPedidoStatus2(PedidoStatusDTO psd ) {
		Pedido pedido = new Pedido();
		pedido.setIdPedido(psd.getId());
		pedido.setStatusPedido(psd.getStatus());
		return pedido;
	}
