...
public class PedidoController {
	...
	@PutMapping("updatePedidoStatus/{pedidoStatus}/{idPedido}")
	public int updatePedidoStatus(@PathVariable Boolean pedidoStatus,
									  @PathVariable Integer idPedido) {
		return pedidoService.updatePedidoStatus(pedidoStatus, idPedido);
	}
